...
**ВНИМАНИЕ: перед тем как устанавливать новый модуль необходимо откатить изменения из [этого](https://github.com/hflabs/suggestions-opencart/blob/11635aa10a304efdf8e5cfface4af2f444823784/doc/install.md) документа (т.е. сделать процедуру обратную установке версии 1.0)**
